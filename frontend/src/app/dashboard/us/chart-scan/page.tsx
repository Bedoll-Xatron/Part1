...
import { chartAnalysisUsAPI as chartAnalysisAPI, ChartAnalysisResult, ChartAnalysisStatus } from '@/lib/api';
    ...
    >
      ...
      >
        ...
        <div className="h-[400px] mb-4">
          <StockChart ticker={result.종목코드} marketType="US" />
        </div>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            미국 주식(S&P 500) 100종목 · Gemini Vision 기술적 분석
          </p>
        </div>
